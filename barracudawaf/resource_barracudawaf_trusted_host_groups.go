...
func resourceCudaWAFTrustedHostGroups() *schema.Resource {
	return &schema.Resource{
		...
		Description: "`barracudawaf_trusted_host_groups` manages `Trusted Host Groups` on the Barracuda Web Application Firewall.",
	}
}
...
func resourceCudaWAFTrustedHostGroupsCreate(d *schema.ResourceData, m interface{}) error {
	...
	err := client.CreateBarracudaWAFResource(name, hydrateBarracudaWAFTrustedHostGroupsResource(d, "post", resourceEndpoint))
	...
	err = client.hydrateBarracudaWAFTrustedHostGroupsSubResource(d, name, resourceEndpoint)
...
func (b *BarracudaWAF) hydrateBarracudaWAFTrustedHostGroupsSubResource(
