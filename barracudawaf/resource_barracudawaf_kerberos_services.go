...
var (
	subResourceKerberosServicesParams = map[string][]string{}
)
...
func resourceCudaWAFKerberosServicesUpdate(d *schema.ResourceData, m interface{}) error {
	...
	resourceEndpoint := "/kerberos-services"
	err := client.UpdateBarracudaWAFResource(name, hydrateBarracudaWAFKerberosServicesResource(d, "put", resourceEndpoint))
...
func hydrateBarracudaWAFKerberosServicesResource(d *schema.ResourceData, method string, endpoint string) *APIRequest {
...
func (b *BarracudaWAF) hydrateBarracudaWAFKerberosServicesSubResource(
	d *schema.ResourceData,
	name string,
	endpoint string,
) error {

	for subResource, subResourceParams := range subResourceKerberosServicesParams {
