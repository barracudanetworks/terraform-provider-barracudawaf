...
func resourceCudaWAFRadiusServices() *schema.Resource {
	return &schema.Resource{
		...
		Description: "`barracudawaf_radius_services` manages `Radius Services` on the Barracuda Web Application Firewall.",
	}
}
...
func resourceCudaWAFRadiusServicesCreate(d *schema.ResourceData, m interface{}) error {
	...
	err := client.CreateBarracudaWAFResource(name, hydrateBarracudaWAFRadiusServicesResource(d, "post", resourceEndpoint))
	...
	err = client.hydrateBarracudaWAFRadiusServicesSubResource(d, name, resourceEndpoint)
...
func (b *BarracudaWAF) hydrateBarracudaWAFRadiusServicesSubResource(
