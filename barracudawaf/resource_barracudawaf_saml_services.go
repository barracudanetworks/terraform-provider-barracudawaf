...
var (
	subResourceSamlServicesParams = map[string][]string{}
)
...
func resourceCudaWAFSamlServicesCreate(d *schema.ResourceData, m interface{}) error {
	...
	err := client.CreateBarracudaWAFResource(name, hydrateBarracudaWAFSamlServicesResource(d, "post", resourceEndpoint))
	...
	err = client.hydrateBarracudaWAFSamlServicesSubResource(d, name, resourceEndpoint)
...
func resourceCudaWAFSamlServicesUpdate(d *schema.ResourceData, m interface{}) error {
	...
	resourceEndpoint := "/saml-services"
	err := client.UpdateBarracudaWAFResource(name, hydrateBarracudaWAFSamlServicesResource(d, "put", resourceEndpoint))
...
func hydrateBarracudaWAFSamlServicesResource(d *schema.ResourceData, method string, endpoint string) *APIRequest {
...
func (b *BarracudaWAF) hydrateBarracudaWAFSamlServicesSubResource(
	d *schema.ResourceData,
	name string,
	endpoint string,
) error {

	for subResource, subResourceParams := range subResourceSamlServicesParams {
